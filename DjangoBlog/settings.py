...
SITE_ID = 1
BAIDU_NOTIFY_URL = "http://data.zz.baidu.com/urls?site=https://blog.caixinglong.cn&token=RjXUmBvx24HvCnJl"
...
ADMINS = [('caixinglong', '449642275@qq.com')]
# 微信管理员密码(两次md5获得)
